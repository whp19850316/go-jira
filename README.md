...
[![GoDoc](https://godoc.org/github.com/whp19850316/go-jira?status.svg)](https://godoc.org/github.com/whp19850316/go-jira)
[![Build Status](https://travis-ci.org/whp19850316/go-jira.svg?branch=master)](https://travis-ci.org/whp19850316/go-jira)
[![Go Report Card](https://goreportcard.com/badge/github.com/whp19850316/go-jira)](https://goreportcard.com/report/github.com/whp19850316/go-jira)
...
```bash
go get github.com/whp19850316/go-jira
```
...
import (
	jira "gopkg.in/whp19850316/go-jira.v1"
)
...
```
...
```bash
cd $GOPATH/src/github.com/whp19850316/go-jira
go test -v ./...
```

## API

Please have a look at the [GoDoc documentation](https://godoc.org/github.com/whp19850316/go-jira) for a detailed API description.
...
A few more examples are available in the [GoDoc examples section](https://godoc.org/github.com/whp19850316/go-jira#pkg-examples).
...
import (
	"fmt"
	"github.com/whp19850316/go-jira"
)
...
For more details have a look at the [issue #56](https://github.com/whp19850316/go-jira/issues/56).
...
please look at [Pagination Example](https://github.com/whp19850316/go-jira/blob/master/examples/pagination/main.go)
...
* [whp19850316/jitic](https://github.com/whp19850316/jitic) - The Jira Ticket Checker
...
Creating issues or holding talks and help other people to use [go-jira](https://github.com/whp19850316/go-jira) is contribution, too!
A few examples:

* Correct typos in the README / documentation
* Reporting bugs
* Implement a new feature or endpoint
* Sharing the love of [go-jira](https://github.com/whp19850316/go-jira) and help people to get use to it
...
[https://github.com/whp19850316/go-jira/releases/edit/v1.11.0](https://github.com/whp19850316/go-jira/releases/edit/v1.11.0)
